...
ACCESS_KEY_ID = "LTAI4FieVRM8rCBtqMnsQ8vs"  # 用户AccessKey  需要根据自己的账户修改
ACCESS_KEY_SECRET = "WeYPkVbfMTyt6RzfDbNlAeic93eEMo"  # Access Key Secret  需要根据自己的账户修改
